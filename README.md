...
## Files Included
- `class1survey_cleaned.csv`: Cleaned version of the Class 1 survey dataset
- `class1survey_analysis.Rmd`: R script used to summarize and visualize the data
- `README.md`: This file
...
2. Open `class1survey_analysis.Rmd` in RStudio
